...
class RegistrationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'email'          => 'required|email|max:150|unique:registrations,email,NULL,id,event_id,' . $request->event_id,
            'phone'          => 'required|string|max:20|regex:/^[0-9+\-\s]+$/|unique:registrations,phone,NULL,id,event_id,' . $request->event_id,
            'id_number'      => 'required|string|size:16|unique:registrations,id_number,NULL,id,event_id,' . $request->event_id,
            ...
            'phone.unique'            => 'Nomor WhatsApp ini sudah terdaftar untuk event ini.',
            'id_number.required'      => 'NIK / No. KTP wajib diisi.',
            'id_number.size'          => 'NIK harus berjumlah 16 digit.',
            'id_number.unique'        => 'NIK ini sudah terdaftar untuk event ini.',
