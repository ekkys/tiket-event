...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: 
                radial-gradient(circle at 10% 20%, rgba(92, 59, 254, 0.05) 0%, transparent 20%),
        ...
        @keyframes dotFlashing {
            ...
            50%, 100% { background-color: #EEECFF; }
        }
...
<div class="card">
    ...
    <p>
        Pendaftaran Anda untuk <span class="event-name-tag">{{ $registration->event->name }}</span> telah berhasil kami terima.
        <br><br>
        @if($registration->payment_status === 'free')
            Tiket digital Anda sedang dibuat. Silakan cek email Anda secara berkala atau klik tombol di bawah untuk melihat tiket langsung.
        @else
